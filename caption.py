...
def caption_image_beam_search(encoder, decoder, image_path, word_map, beam_size=5, max_len = 20):
    ...
    while True:
        ...
        # score_list[0].append(scores.tolist()[0][step - 1])

        # Add
        # scores => torch.Size([5, word_map_len])
    ...
    # print(to_caps(hot_list=score_list, is_all_hot=True))
...
if __name__ == '__main__':
    ...
    word_map_path = 'out_data/coco/out_hdf5/per_5_freq_5_maxlen_100/WORDMAP_coco_5_cap_per_img_5_min_word_freq.json'  # 单词映射 JSON 路径
